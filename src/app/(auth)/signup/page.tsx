      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="inline-block p-4 rounded-full heritage-gradient heritage-glow mb-4">
          ...
          <Card className="backdrop-blur-xl bg-white/95 border-white/30 shadow-2xl heritage-glow">
            ...
            <CardContent>
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="font-ubuntu font-medium text-gray-700">
                    Confirm Password
                  </Label>
                  <Input
                    id="confirmPassword"
                ...
                <div className="space-y-2">
                  <Label htmlFor="heritage" className="font-ubuntu font-medium text-gray-700">
                    Heritage Background (Optional)
                  </Label>
                  <select
                    id="heritage"
                    name="heritage"
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-700 font-ubuntu">
                    I agree to the{" "}
                    <Link href="/terms" className="font-medium font-ubuntu heritage-gradient bg-clip-text text-transparent hover:opacity-80 transition-opacity duration-200">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/privacy" className="font-medium font-ubuntu heritage-gradient bg-clip-text text-transparent hover:opacity-80 transition-opacity duration-200">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-heritage-gold focus:ring-heritage-gold border-gray-300 rounded transition-all duration-200"
                  />
                  <label htmlFor="newsletter" className="ml-2 block text-sm text-gray-700 font-ubuntu">
              ...
              <div className="mt-8">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white text-gray-500 font-ubuntu">Or sign up with</span>
                  </div>
                </div>
