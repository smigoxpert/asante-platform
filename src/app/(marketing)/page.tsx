      ...
      <div className="relative z-10">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
          <div className="max-w-7xl mx-auto text-center">
            ...
            {/* Inspirational Quote */}
            <div className="mb-12 p-6 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 max-w-2xl mx-auto">
              <p className="text-white/80 text-lg italic font-ubuntu">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button 
                size="lg" 
                className="heritage-gradient hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300 font-ubuntu font-semibold text-white px-8 py-4 text-lg"
              >
              ...
              <Button 
                size="lg" 
                className="border-2 border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-8 py-4 text-lg font-ubuntu font-medium transition-all duration-300 bg-transparent"
              >
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="backdrop-blur-xl bg-white/95 border-white/30 shadow-2xl heritage-glow hover:transform hover:scale-105 transition-all duration-300">
                <CardHeader>
                  <div className="inline-block p-3 rounded-full heritage-gradient mb-4">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                  </div>
                  <CardTitle className="text-heritage-gold font-ubuntu font-bold">Ubuntu Dashboard</CardTitle>
              ...
              <Card className="backdrop-blur-xl bg-white/95 border-white/30 shadow-2xl heritage-glow hover:transform hover:scale-105 transition-all duration-300">
                <CardHeader>
                  ...
                  <CardTitle className="text-heritage-gold font-ubuntu font-bold">Heritage Discovery</CardTitle>
                  <CardDescription className="font-ubuntu">
              ...
              <Card className="backdrop-blur-xl bg-white/95 border-white/30 shadow-2xl heritage-glow hover:transform hover:scale-105 transition-all duration-300">
                <CardHeader>
                  ...
                  <CardTitle className="text-heritage-gold font-ubuntu font-bold">Wisdom Paths</CardTitle>
                  <CardDescription className="font-ubuntu">
              ...
              <Card className="backdrop-blur-xl bg-white/95 border-white/30 shadow-2xl heritage-glow hover:transform hover:scale-105 transition-all duration-300">
                <CardHeader>
                  ...
                  <CardTitle className="text-heritage-gold font-ubuntu font-bold">Community Circles</CardTitle>
                  <CardDescription className="font-ubuntu">
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-white/70 text-sm font-ubuntu italic">
